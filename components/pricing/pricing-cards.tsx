      ...
      <section className="flex flex-col items-center text-center">
        ...
        <p className="mt-3 text-balance text-center text-base text-muted-foreground">
          ...
          <a
            ...
            href="mailto:support@trybarty.com"
          >
            support@trybarty.com
          </a>{" "}
          with any questions about our referral plans.
          <br />
          <strong>
            Get your first 20 referral emails free when you sign up.
          </strong>
        </p>
      </section>
    </MaxWidthWrapper>
